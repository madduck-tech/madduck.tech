...
image_alt: 'Diagram of an AI garden: sensors send data through an ESP32 to a local model that controls a greenhouse'
image_caption: From sensors to decisions, and from decisions to irrigation, ventilation, and other greenhouse systems.
---
